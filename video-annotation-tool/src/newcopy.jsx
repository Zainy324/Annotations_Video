            ...
            {selectedAnnotationId && (() => {
              ...
              return (
                ...
                >
                  ...
                  {/* ...existing edit menu code (move, delete, text input) */}
                </div>
              );
            })()}
...
>
  <div className="flex items-center w-full gap-3 px-4 py-2">
    {/* Undo/Redo */}
    <button onClick={handleUndo} disabled={history.length <= 1} className="p-2 bg-gray-600 hover:bg-gray-700 rounded text-xs">Undo</button>
    <button onClick={handleRedo} disabled={redoStack.length === 0} className="p-2 bg-gray-600 hover:bg-gray-700 rounded text-xs">Redo</button>
    {/* Play/Pause */}
    <button onClick={handlePlayPause} className="p-2 bg-red-600 hover:bg-red-700 rounded">
      {isPlaying ? <Pause size={20} /> : <Play size={20} />}
    </button>
    {/* Frame Navigation */}
    <button onClick={() => handleFrameNavigation('prev')} className="p-2 bg-gray-600 hover:bg-gray-700 rounded">
      <RotateCcw size={20} />
    </button>
    <button onClick={() => handleFrameNavigation('next')} className="p-2 bg-gray-600 hover:bg-gray-700 rounded">
      <RotateCw size={20} />
    </button>
    {/* Time */}
    ...
    {/* Fullscreen */}
    <button
      className="p-2 bg-gray-600 hover:bg-gray-700 rounded ml-2"
